...
/**
 * The Soroban contract ID for the Million contract.
 */
export const CONTRACT_ID = 'CBR33SLBHCH7DRYIXT4PAOI6KIU6IDHH72FMJGCIGUBKRVU6HLQ4HXVN'

/**
 * The Soroban contract ID for the Million contract, in hex.
